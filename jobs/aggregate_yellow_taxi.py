...
ANALYTICS_HDFS_BASE = "hdfs://namenode:9000/data/nyc_tlc/yellow/analytics"
LOCAL_EXPORT_BASE = Path("/workspace/output/eda/yellow")
ZONE_LOOKUP_PATH = "/workspace/data/taxi_zone_lookup.csv"


def build_spark_session() -> SparkSession:
    return (
        SparkSession.builder.appName("aggregate_yellow_taxi")
